...
import { donutData, donutTotal } from '../../mock/annualCostDonutData';
import { categoryColors } from '../../mock/monthlyCostStackData';

// ==================== 组件 ====================

const AnnualCostDonut: FC = () => {
  ...
  return (
    <Card
      ...
      style={{ height: '100%' }}
      title={
        <span style={{ fontWeight: 600, fontSize: 16 }}>🍩 全年费用构成</span>
      }
    >
      <Pie
        height={400}
...
export default AnnualCostDonut;
